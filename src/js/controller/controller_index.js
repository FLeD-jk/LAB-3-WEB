...
export default class PostController {
  ...
  addPost() {
    ...
    const modal = bootstrap.Modal.getInstance(document.querySelector('#add_post_modal'))
    modal.hide()
  }
  ...
  handleSubnavigationClick(button) {
    const navTagButtons = document.querySelectorAll('.list-group-item-action')
    navTagButtons.forEach((prevButton) => prevButton.classList.remove('selected'))
  ...
  getSelectedTag() {
    const selectedTagButton = document.querySelector('.list-group-item-action.selected')
